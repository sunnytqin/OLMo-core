...
CHECKPOINTS=(
  "$BEST_RUNS/370M_seed42_multiepoch_dolma_chin0.1_epoch2_wd0.1_lr0.003/step706"
  ...
  "$BEST_RUNS/370M_seed42_multiepoch_dolma_chin0.1_epoch32_wd0.8_lr0.003/step11292"
)

CKPT="${CHECKPOINTS[$SLURM_ARRAY_TASK_ID]}"
echo "Worker $SLURM_ARRAY_TASK_ID -> $CKPT"

# Node-local HF + triton caches so array tasks don't collide on shared scratch
