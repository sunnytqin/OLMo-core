...
FILE_LISTS["src/olmo_core/data/mixes/OLMo-mix-0625-150Bsample.txt"]="allenai/dolma2-tokenizer" # full 150B dolma2 corpus
# FILE_LISTS["src/olmo_core/data/mixes/v3-small-ppl-validation.txt"]="dolma2-tokenizer" # validation set (already downloaded)
