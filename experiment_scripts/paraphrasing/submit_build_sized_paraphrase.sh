...
# Union of unique shard names across all model ladders (14M..370M).
# 27 unique shards.
SHARDS="train_0.014B,train_0.028B,train_0.03B,train_0.06B,train_0.07B,train_0.12B,train_0.14B,train_0.15B,train_0.19B,train_0.28B,train_0.3B,train_0.37B,train_0.38B,train_0.56B,train_0.6B,train_0.74B,train_0.95B,train_1.12B,train_1.2B,train_1.9B,train_2.24B,train_2.4B,train_3.7B,train_3.8B,train_4.48B,train_4.8B,train_7.4B"
