...
EVAL_ONLY=${EVAL_ONLY:-false}  # Set to true to run eval only (no training)
NGPU=${NGPU:-1}  # Number of GPUs per node
...
# Case 4: Extend training FLOPs by multi-epoch training 
TRAINING_SCRIPT="src/scripts/official/OLMo-scale-train-multiepoch-dolma.py"
