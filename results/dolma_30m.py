...
data_0_05x_para = {
    ...
    'K': [1, 2, 4, 8, 16, 32],
    'tokens_trained': [39175842, 49337008, 69148369, 108521507, 188677952, 336906032],
    'flops_multiplier': [0.0653, 0.0822, 0.1152, 0.1809, 0.3145, 0.5615],
    'validation_loss': [8.1116, 8.0923, 7.927, 7.6174, 7.1125, 6.4203],
    'learning_rate': [3e-3, 3e-3, 3e-3, 3e-3, 3e-3, 3e-3],
    'weight_decay': [0.1, 0.2, 0.1, 0.2, 0.1, 0.1],
}
...
data_0_1x_para = {
    ...
    'flops_multiplier': [0.1308, 0.1646, 0.2308, 0.3621, 0.6303, 1.1308],
    'validation_loss': [7.9215, 7.6659, 7.3115, 6.8166, 6.3976, 5.6123],
    'learning_rate': [3e-3, 3e-3, 3e-3, 3e-3, 3e-3, 3e-3],
    'weight_decay': [0.1, 0.1, 0.2, 0.1, 0.1, 0.1],
}

data_0_25x_para = {
    'chinchilla_scale': [0.25, 0.25, 0.25, 0.25, 0.25, 0.25],
    'K': [1, 2, 4, 8, 16, 32],
    'tokens_trained': [196180701, 246460684, 345235508, 541210823, 942174820, 1689023401],
    'flops_multiplier': [0.327, 0.4108, 0.5754, 0.902, 1.5703, 2.815],
    'validation_loss': [6.9562, 6.6982, 6.2638, 5.7962, 5.3471, 4.5383],
    'learning_rate': [3e-3, 3e-3, 3e-3, 3e-3, 3e-3, 3e-3],
    'weight_decay': [0.1, 0.2, 0.1, 0.2, 0.1, 0.1],
}
...
data_1x_para = {
    ...
    'flops_multiplier': [1.3085, 1.643, 2.303, 3.6114, 6.2907, 11.2866],
    'validation_loss': [5.388, 5.1273, 4.6489, 4.275, 4.0397, 3.8978],
    'learning_rate': [3e-3, 3e-3, 3e-3, 3e-3, 3e-3, 3e-3],
    'weight_decay': [0.1, 0.2, 0.2, 0.1, 0.1, 0.1],
}
...
data_2x_para = {
    ...
    'flops_multiplier': [2.6181, 3.2858, 4.6088, 7.2274, 12.5912, 22.5835],
    'validation_loss': [4.5164, 4.3329, 4.1125, 3.9939, 3.8717, 3.8065],
    'learning_rate': [3e-3, 3e-3, 3e-3, 3e-3, 3e-3, 3e-3],
    'weight_decay': [0.1, 0.1, 0.1, 0.2, 0.1, 0.1],
}

data_4x_para = {
    'chinchilla_scale': [4, 4, 4, 4, 4, 4],
    'K': [1, 2, 4, 8, 16, 32],
    'tokens_trained': [3139428300, 3939920760, 5525520833, 8667602961, 15103210246, 27083586228],
    'flops_multiplier': [5.2324, 6.5665, 9.2092, 14.446, 25.172, 45.1393],
    'validation_loss': [4.0514, 3.9715, 3.8848, 3.8209, 3.7574, 3.7184],
    'learning_rate': [3e-3, 3e-3, 3e-3, 3e-3, 3e-3, 3e-3],
    'weight_decay': [0.1, 0.1, 0.2, 0.1, 0.1, 0.1],
}

data_8x_para = {
    'chinchilla_scale': [8, 8, 8, 8, 8, 8],
    'K': [1, 2, 4, 8, 16, 32],
    'tokens_trained': [6273079931, 7868567196, 11032447728, 17302500551, 30144742585, 54043590070],
    'flops_multiplier': [10.4551, 13.1143, 18.3874, 28.8375, 50.2412, 90.0727],
    'validation_loss': [3.8305, 3.8112, 3.7595, 3.723, 3.6993, 3.6857],
    'learning_rate': [3e-3, 3e-3, 3e-3, 3e-3, 3e-3, 3e-3],
    'weight_decay': [0.1, 0.2, 0.1, 0.1, 0.1, 0.1],
}
