...
data_4x_para = {
    ...
    'flops_multiplier': [5.2324, 6.5665, 9.2092, 14.446, 25.172],
    'validation_loss': [4.0514, 3.9715, 3.8848, 3.8209, 3.7574],
    'learning_rate': [3e-3, 3e-3, 3e-3, 3e-3, 3e-3],
    'weight_decay': [0.1, 0.1, 0.2, 0.1, 0.1],
}
...
data_8x_para = {
    ...
    'flops_multiplier': [10.4551, 13.1143, 18.3874, 28.8375, 50.2412],
    'validation_loss': [3.8305, 3.8112, 3.7595, 3.723, 3.6993],
    'learning_rate': [3e-3, 3e-3, 3e-3, 3e-3, 3e-3],
