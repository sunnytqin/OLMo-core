...
data_0_1x = {
    ...
    'learning_rate': [0.001, 0.003, 0.003, 0.003, 0.003, 0.003, 0.003],
...
data_0_25x = {
    ...
    'validation_loss': [3.6723, 3.1607, 2.9488, 2.8186, 2.7617, 2.7460],
...
data_1x = {
    ...
    'epochs': [1, 2, 4, 8],
    'flops_multiplier': [1.0, 2.0, 4.0, 8.0],
    'validation_loss': [2.9141, 2.7418, 2.6505, 2.6048],
    'learning_rate': [0.003, 0.003, 0.003, 0.003],
    'weight_decay': [0.2, 0.2, 0.2, 0.2],
}

data_2x = {
    'chinchilla_scale': [2, 2, 2],
    'epochs': [1, 2, 4],
    'flops_multiplier': [2.0, 4.0, 8.0],
    'validation_loss': [2.7294, 2.6353, 2.5946],
    'learning_rate': [0.003, 0.003, 0.003],
    'weight_decay': [0.2, 0.2, 0.2],
}
