...
data_0_05x = {
    ...
    'validation_loss': [8.0672, 7.4312, 6.7200, 5.9770, 5.2110, 4.6546, 4.5379],
    'learning_rate': [0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.003],
...
data_0_1x = {
    ...
    'validation_loss': [7.4437, 6.7208, 5.9500, 5.2172, 4.3406, 4.0327, 4.4086],
...
data_0_25x = {
    ...
    'validation_loss': [6.4191, 5.7035, 4.8439, 4.0984, 3.7427, 3.6685, 3.7610],
    'learning_rate': [0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001],
    'weight_decay': [0.1, 0.1, 0.1, 0.1, 0.2, 0.4, 0.4],
}
...
data_1x = {
    ...
    'epochs': [1, 4, 8, 16, 32],
    'flops_multiplier': [1.0, 4.0, 8.0, 16.0, 32.0],
    'validation_loss': [4.9059, 3.6322, 3.4454, 3.3374, 3.3004],
...
data_2x = {
    ...
    'epochs': [1, 4, 8, 16],
    'flops_multiplier': [2.0, 8.0, 16.0, 32.0],
    'validation_loss': [4.0581, 3.4269, 3.3075, 3.2443],
...
data_4x = {
    ...
    'epochs': [1, 4, 8],
    'flops_multiplier': [4.0, 16.0, 32.0],
    'validation_loss': [3.6284, 3.3010, 3.2250],
...
data_8x = {
    ...
    'epochs': [1, 4],
    'flops_multiplier': [8.0, 32.0],
    'validation_loss': [3.4235, 3.2159],
